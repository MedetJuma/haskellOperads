...
The -N flag can be adjusted by appending a number of processors. For example, -N30 would mean that the process will use at most 30 processors. The -A64m flag specifies the garbage collector size, which is set to 64 MB.
