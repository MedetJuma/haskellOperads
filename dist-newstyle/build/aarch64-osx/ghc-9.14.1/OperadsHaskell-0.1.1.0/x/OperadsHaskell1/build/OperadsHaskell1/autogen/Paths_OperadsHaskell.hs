...
-- at runtime using the environment variable OperadsHaskell_bindir.
...
-- environment variable OperadsHaskell_libdir.
...
-- using the environment variable OperadsHaskell_dynlibdir.
...
-- runtime using the environment variable OperadsHaskell_datadir.
...
-- variable OperadsHaskell_libexedir.
...
-- using the environment variable OperadsHaskell_sysconfdir.
...
libdir     = "/Users/a1/.cabal/lib/aarch64-osx-ghc-9.14.1-ea4f/OperadsHaskell-0.1.1.0-inplace-OperadsHaskell1"
dynlibdir  = "/Users/a1/.cabal/lib/aarch64-osx-ghc-9.14.1-ea4f"
datadir    = "/Users/a1/.cabal/share/aarch64-osx-ghc-9.14.1-ea4f/OperadsHaskell-0.1.1.0"
libexecdir = "/Users/a1/.cabal/libexec/aarch64-osx-ghc-9.14.1-ea4f/OperadsHaskell-0.1.1.0"
sysconfdir = "/Users/a1/.cabal/etc"

getBinDir     = catchIO (getEnv "OperadsHaskell_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "OperadsHaskell_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "OperadsHaskell_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "OperadsHaskell_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "OperadsHaskell_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "OperadsHaskell_sysconfdir") (\_ -> return sysconfdir)
