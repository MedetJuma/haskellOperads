...
/* package OperadsHaskell-0.1.1.0 */
#ifndef VERSION_OperadsHaskell
#define VERSION_OperadsHaskell "0.1.1.0"
#endif /* VERSION_OperadsHaskell */
#ifndef MIN_VERSION_OperadsHaskell
#define MIN_VERSION_OperadsHaskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 1)
#endif /* MIN_VERSION_OperadsHaskell */
...
#define CURRENT_COMPONENT_ID "OperadsHaskell-0.1.1.0-inplace-OperadsHaskell1"
