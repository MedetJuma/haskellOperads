...
-- at runtime using the environment variable OperadsHaskell1_bindir.
...
-- environment variable OperadsHaskell1_libdir.
...
-- using the environment variable OperadsHaskell1_dynlibdir.
...
-- runtime using the environment variable OperadsHaskell1_datadir.
...
-- variable OperadsHaskell1_libexedir.
...
-- using the environment variable OperadsHaskell1_sysconfdir.
...
getLibDir     = catchIO (getEnv "OperadsHaskell1_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "OperadsHaskell1_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "OperadsHaskell1_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "OperadsHaskell1_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "OperadsHaskell1_sysconfdir") (\_ -> return sysconfdir)
